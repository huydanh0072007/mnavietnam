...
export const FALLBACK_PROVINCES = [
  { code: '01', name: 'Thành phố Hà Nội', sort_order: 1, is_active: true },
  { code: 'TT-HUE', name: 'Thành phố Huế', sort_order: 2, is_active: true },
  { code: '20', name: 'Tỉnh Lạng Sơn', sort_order: 3, is_active: true },
  { code: '17', name: 'Tỉnh Quảng Ninh', sort_order: 4, is_active: true },
  { code: '38', name: 'Tỉnh Thanh Hóa', sort_order: 5, is_active: true },
  { code: '40', name: 'Tỉnh Nghệ An', sort_order: 6, is_active: true },
  { code: '42', name: 'Tỉnh Hà Tĩnh', sort_order: 7, is_active: true },
  { code: '04', name: 'Tỉnh Cao Bằng', sort_order: 8, is_active: true },
  { code: '12', name: 'Tỉnh Lai Châu', sort_order: 9, is_active: true },
  { code: '11', name: 'Tỉnh Điện Biên', sort_order: 10, is_active: true },
  { code: '14', name: 'Tỉnh Sơn La', sort_order: 11, is_active: true },
  { code: 'TQ-HG', name: 'Tỉnh Tuyên Quang', sort_order: 12, is_active: true },
  { code: 'LC-YB', name: 'Tỉnh Lào Cai', sort_order: 13, is_active: true },
  { code: 'TN-BK', name: 'Tỉnh Thái Nguyên', sort_order: 14, is_active: true },
  { code: 'PT-VP-HB', name: 'Tỉnh Phú Thọ', sort_order: 15, is_active: true },
  { code: 'BN-BG', name: 'Tỉnh Bắc Ninh', sort_order: 16, is_active: true },
  { code: 'HY-TB', name: 'Tỉnh Hưng Yên', sort_order: 17, is_active: true },
  { code: 'HP-HD', name: 'Thành phố Hải Phòng', sort_order: 18, is_active: true },
  { code: 'NB-HN-ND', name: 'Tỉnh Ninh Bình', sort_order: 19, is_active: true },
  { code: 'QT-QB', name: 'Tỉnh Quảng Trị', sort_order: 20, is_active: true },
  { code: 'DN-QN', name: 'Thành phố Đà Nẵng', sort_order: 21, is_active: true },
  { code: 'QNG-KT', name: 'Tỉnh Quảng Ngãi', sort_order: 22, is_active: true },
  { code: 'GL-BD', name: 'Tỉnh Gia Lai', sort_order: 23, is_active: true },
  { code: 'KH-NT', name: 'Tỉnh Khánh Hòa', sort_order: 24, is_active: true },
  { code: 'LD-DN-BT', name: 'Tỉnh Lâm Đồng', sort_order: 25, is_active: true },
  { code: 'DL-PY', name: 'Tỉnh Đắk Lắk', sort_order: 26, is_active: true },
  { code: 'HCM-BD-BRVT', name: 'Thành phố Hồ Chí Minh', sort_order: 27, is_active: true },
  { code: 'DN-BP', name: 'Thành phố Đồng Nai', sort_order: 28, is_active: true },
  { code: 'TN-LA', name: 'Tỉnh Tây Ninh', sort_order: 29, is_active: true },
  { code: 'CT-ST-HG', name: 'Thành phố Cần Thơ', sort_order: 30, is_active: true },
  { code: 'VL-BT-TV', name: 'Tỉnh Vĩnh Long', sort_order: 31, is_active: true },
  { code: 'DT-TG', name: 'Tỉnh Đồng Tháp', sort_order: 32, is_active: true },
  { code: 'CM-BL', name: 'Tỉnh Cà Mau', sort_order: 33, is_active: true },
  { code: 'AG-KG', name: 'Tỉnh An Giang', sort_order: 34, is_active: true }
];
